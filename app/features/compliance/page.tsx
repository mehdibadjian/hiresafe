        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <div className="flex flex-col space-y-4 text-center lg:text-left">
              <Scale className="h-8 w-8 text-primary mx-auto lg:mx-0" />
            ...
            <div className="flex flex-col space-y-4 text-center lg:text-left">
              <FileText className="h-8 w-8 text-primary mx-auto lg:mx-0" />
            ...
            <div className="flex flex-col space-y-4 text-center lg:text-left">
              <ShieldAlert className="h-8 w-8 text-primary mx-auto lg:mx-0" />
